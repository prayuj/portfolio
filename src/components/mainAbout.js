...
const About = ({ show, delay = 500 }) => {
    ...
    const three = <p>I currently work at <a target="_blank" rel="noreferrer" href="https://urls.prayuj.tech/t/cimpress?message=Cimpress" className="content-hover-link">Cimpress</a> as part of their Business subsidiary, <a target="_blank" rel="noreferrer" href="https://urls.prayuj.tech/t/np?message=National%20Pen" className="content-hover-link">National Pen.</a></p>
